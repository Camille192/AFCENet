...
class AdaptiveWeightFeatureFusionModule(nn.Module):
    def __init__(self, in_d, out_d):
        super(AdaptiveWeightFeatureFusionModule, self).__init__()
        self.in_d = in_d
        self.out_d = out_d
    ...
    def forward(self, x1, x2):
        ...
        x_att = self.bam(x_sub, x_cat, raw_x1=x1, raw_x2=x2)
...
if __name__ == '__main__':
    ...
    model = AdaptiveWeightFeatureFusionModule(128, 128)
    out = model(x1, x2)
