...
def get_model(backbone_name='mobilenetv2', afem_name='afem', afem_channels=128, deform_groups=4,
    ...
    detector = Detector(backbone_name, afem_name, afem_channels, deform_groups, gamma_mode, beta_mode,
...
class Model(nn.Module):
    def __init__(self, opt):
        ...
        self.detector = get_model(backbone_name=opt.backbone, afem_name=opt.afem, afem_channels=opt.afem_channels,
